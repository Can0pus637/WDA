...
HD_PWD='C:/Users/Boyang/Desktop/FPGA-Matrix-Accelerator/FIP_TC/FIP_TC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_TC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_TC.tcl -notrace
