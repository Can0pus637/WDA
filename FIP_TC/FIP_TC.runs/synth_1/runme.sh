...
HD_PWD='C:/Users/Boyang/Desktop/FPGA-Matrix-Accelerator/FIP_TC/FIP_TC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_TC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_TC.tcl
