...
HD_PWD='C:/Users/Boyang/Desktop/m16/FIP_OBC/FIP_OBC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_OBC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_OBC.tcl -notrace
