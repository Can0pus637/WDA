...
HD_PWD='C:/Users/Boyang/Desktop/m16/FIP_OBC/FIP_OBC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_OBC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_OBC.tcl
