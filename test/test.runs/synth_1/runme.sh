...
HD_PWD='C:/Users/Boyang/Desktop/FPGA-Matrix-Accelerator/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_demo.tcl
