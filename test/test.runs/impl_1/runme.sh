...
HD_PWD='C:/Users/Boyang/Desktop/FPGA-Matrix-Accelerator/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_demo.tcl -notrace
